...
void draw(){
 ...
 if(mousePressed){
  ...
  line(576,-58,mouseX-300,mouseY-(height/2));
 }  


        int xx=-1396;
        int yy=-85*3;
        float c=0.9885186378418306671598900870289;
        float s=-0.15109898291958031217676488874948;
        line(c*xx-s*yy+698,s*xx+c*yy-73,698,-73);
