...
void draw(){
 ...
 beginShape();
 for(int i=0;i<lines410.length;i++){
 vertex(t10[i][0],t10[i][1]);
 }
 endShape(CLOSE);
 stroke(255);
 
 if(mousePressed){
  line(-800,0,mouseX-width/2,mouseY-height/2); 
 }
